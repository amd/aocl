...
# Enabling additional cmake flags needed to link openmp in Windows
if(WIN32 AND ENABLE_MULTITHREADING)
    set(OMP_OPTIONS 
        -DEXTERNAL_OMP_LIBRARY=${OpenMP_libomp_LIBRARY} 
        -DUSE_EXTERNAL_OMP_LIB=ON
    )
else()
    set(OMP_OPTIONS "")
endif()
...
file(APPEND "${SPARSE_BUILD_LOG_FILE_PATH}" "CONFIGURATION COMMAND: cmake -G \"${CMAKE_GENERATOR}\" -S ${SPARSE_DIR} -B ${CMAKE_BINARY_DIR}/aocl-sparse/build_dir -DCMAKE_CONFIGURATION_TYPES=${CMAKE_CONFIGURATION_TYPES} -DBUILD_ILP64=${ENABLE_ILP64} -DUSE_AVX512=${SPARSE_ISA_CONFIG} -DSUPPORT_OMP=${ENABLE_MULTITHREADING} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DAOCL_BLIS_LIB=${AOCL_BLIS_LIB} -DAOCL_BLIS_INCLUDE_DIR=${CMAKE_BINARY_DIR}/blis/install_package/include -DAOCL_LIBFLAME=${AOCL_LIBFLAME} -DAOCL_LIBFLAME_INCLUDE_DIR=${CMAKE_BINARY_DIR}/libflame/install_package/include -DAOCL_UTILS_LIB=${AOCL_UTILS_LIB} -DAOCL_UTILS_INCLUDE_DIR=${CMAKE_BINARY_DIR}/aocl-utils/install_package/include/alci -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/aocl-sparse/install_package ${OMP_OPTIONS} ${CompilerToolSet}.\n")
...
execute_process(
    COMMAND cmake --build ${CMAKE_BINARY_DIR}/aocl-sparse/build_dir --config ${CMAKE_BUILD_TYPE} --target install ${parallel}
    WORKING_DIRECTORY ${SPARSE_DIR}
    RESULT_VARIABLE result
    OUTPUT_VARIABLE output
    ERROR_VARIABLE error
