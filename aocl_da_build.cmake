...
# Source resolution: local DA_PATH > git clone.
if(DA_PATH)
...
# Compiler toolset based on the generator.
...
if(substring_position EQUAL -1)
    ...
    if(CMAKE_Fortran_COMPILER)
        list(APPEND CompilerToolSet -DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER})
    endif()
endif()

# Ninja + clang-cl + ifx: clear IntelLLVM Fortran linker-wrapper flags so
# lld-link sees plain /LIBPATH: and /DEF: instead of "/Qoption,link,...".
if(CMAKE_GENERATOR MATCHES "Ninja")
    set(_DA_LLD_FIX "${CMAKE_BINARY_DIR}/aocl-data-analytics/da_lld_link_fix.cmake")
    file(WRITE "${_DA_LLD_FIX}"
...
")
    list(APPEND CompilerToolSet
         "-DCMAKE_PROJECT_TOP_LEVEL_INCLUDES=${_DA_LLD_FIX}"
         "-DCMAKE_USER_MAKE_RULES_OVERRIDE_Fortran=${_DA_LLD_FIX}")
    message(STATUS "AOCL-DA: generated lld-link Fortran-wrapper fix at ${_DA_LLD_FIX}")
endif()

# Platform-specific dependency library paths.
if(WIN32)
...
# Drop CMake-internal directories that aren't needed by the umbrella build.
if(substring_position EQUAL -1)
    execute_process(
...
# Collect object files (and the generated DEF file on Windows) for the umbrella lib.
if(substring_position EQUAL -1)
...
# Install AOCL-DA headers (LP64 vs ILP64).
if(ENABLE_ILP64)
